                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                      ...
                                      <form action="{{ route('admin.newUserRegister') }}" method="POST" novalidate>
                                            @csrf
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0">By registering you agree to our 
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Already have an account ? <a href="{{ route('admin.login') }}"
                                                    class="text-primary fw-semibold"> Login </a> </p>
                                        </div>
                                    </div>
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> SHALEEN OVERSEAS<i class="mdi mdi-heart text-danger"></i> by ASK Innovations</p>
                                    </div>
                                </div>
                            </div>
                        </div>
