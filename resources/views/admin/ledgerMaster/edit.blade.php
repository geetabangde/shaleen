      ...
      <div class="row ledger-add-form">
         <div class="col-12">
            <div class="card">
               ...
               <form action="{{ route('admin.ledgerMaster.update', $ledgerMaster->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                     <div class="row">
                        <!-- Left Column -->
                        <div class="col-md-6">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                 value="{{ old('name', $ledgerMaster->name) }}">
                              @error('name') 
                           ...
                           <div class="mb-3">
                              ...
                              <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                                 value="{{ old('email', $ledgerMaster->email) }}">
                              @error('email') 
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                           </div>
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="contact_number" class="form-control @error('contact_number') is-invalid @enderror"
                                 value="{{ old('contact_number', $ledgerMaster->contact_number) }}">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="pan_number" oninput="this.value=this.value.toUpperCase()"
                                 class="form-control @error('pan_number') is-invalid @enderror"
                                 value="{{ old('pan_number', $ledgerMaster->pan_number) }}">
                              @error('pan_number') 
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                           </div>
                           <div class="mb-3">
                              ...
                              <input type="text" name="tan_number" class="form-control @error('tan_number') is-invalid @enderror"
                                 value="{{ old('tan_number', $ledgerMaster->tan_number) }}">
                              @error('tan_number') 
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                           </div>
                           <div class="form-group">
                              ...
                              <div class="d-flex flex-wrap gap-3">
                                 <div class="form-check">
                                    ...
                                    {{ in_array('seller', $ledgerMaster->types ?? []) ? 'checked' : '' }}>
                                 ...
                                 <div class="form-check">
                                    ...
                                    {{ in_array('buyer', $ledgerMaster->types ?? []) ? 'checked' : '' }}>
                                 ...
                                 <div class="form-check">
                                    ...
                                    {{ in_array('broker', $ledgerMaster->types ?? []) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="bank_name" class="form-control @error('bank_name') is-invalid @enderror"
                                 value="{{ old('bank_name', $ledgerMaster->bank_name) }}">
                              @error('bank_name') 
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                           </div>
                           <div class="mb-3">
                              ...
                              <input type="text" name="account_number" class="form-control @error('account_number') is-invalid @enderror"
                                 value="{{ old('account_number', $ledgerMaster->account_number) }}">
                           ...
                           <div class="mb-3">
                              ...
                              <select name="account_type" class="form-control @error('account_type') is-invalid @enderror">
                                 ...
                                 <option value="saving" {{ old('account_type', $ledgerMaster->account_type)=='saving' ? 'selected' : '' }}>Saving</option>
                                 <option value="current" {{ old('account_type', $ledgerMaster->account_type)=='current' ? 'selected' : '' }}>Current</option>
                                 <option value="salary" {{ old('account_type', $ledgerMaster->account_type)=='salary' ? 'selected' : '' }}>Salary</option>
                              </select>
                              @error('account_type') 
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="ifsc_code" oninput="this.value=this.value.toUpperCase()"
                                 class="form-control @error('ifsc_code') is-invalid @enderror"
                                 value="{{ old('ifsc_code', $ledgerMaster->ifsc_code) }}">
                              @error('ifsc_code') 
                              <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                           </div>
                           ...
                           <div id="addressContainer">
                              ...
                              <div class="address-group border rounded p-3 mb-3">
                                 <div class="mb-3">
                                    ...
                                    <input type="text" name="address[{{ $i }}][consignment_address]" class="form-control"
                                    value="{{ old("address.$i.consignment_address", $address['consignment_address'] ?? '') }}" required>
                                 </div>
                                 <div class="mb-3">
                                    <label class="form-label">PIN Code</label>
                                    <input type="text" name="address[{{ $i }}][pincode]" class="form-control"
                                    value="{{ old("address.$i.pincode", $address['pincode'] ?? '') }}" required>
                                 </div>
                                 <div class="mb-3">
                                    <label class="form-label">State</label>
                                    <input type="text" name="address[{{ $i }}][state]" class="form-control"
                                    value="{{ old("address.$i.state", $address['state'] ?? '') }}" required>
                                 </div>
                                 <div class="mb-3">
                                    <label class="form-label">Country</label>
                                    <select name="address[{{ $i }}][country]" class="form-control" required>
                                    <option value="India" {{ (old("address.$i.country", $address['country'] ?? '')=='India') ? 'selected' : '' }}>India</option>
                                    <option value="USA" {{ (old("address.$i.country", $address['country'] ?? '')=='USA') ? 'selected' : '' }}>USA</option>
                                    <option value="UK" {{ (old("address.$i.country", $address['country'] ?? '')=='UK') ? 'selected' : '' }}>UK</option>
                                    <option value="Canada" {{ (old("address.$i.country", $address['country'] ?? '')=='Canada') ? 'selected' : '' }}>Canada</option>
                                    </select>
                                 </div>
                                 <div class="text-end">
