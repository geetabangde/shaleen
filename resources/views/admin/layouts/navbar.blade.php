   ...
   <div class="navbar-header">
      <div class="d-flex">
         ...
         <div class="navbar-brand-box">
            ...
            <span class="logo-sm">
            <img src="{{ asset('backend/images/logo/logotitleshaleen.jpg') }}" alt="" height="30" style="height:60px; width:auto; margin-left: -20px;">
            </span>
            <span class="logo-lg">
            <img src="{{ asset('backend/images/logo/logoshaleen.png') }}" alt="" height="70"> <span class="logo-txt"></span>
            </span>
            </a>
            <a href="index.html" class="logo logo-light">
            <span class="logo-sm">
            <img src="{{ asset('backend/images/logo/logotitleshaleen.jpg') }}" alt="" height="30">
            </span>
            <span class="logo-lg">
            <img src="{{ asset('backend/images/logo/logoshaleen.png') }}" alt="" height="50"> <span class="logo-txt"></span>
            </span>
            </a>
         </div>
   ...
   <script>
      document.addEventListener("DOMContentLoaded", function() {
          ...
          toastElList.forEach(function(toastEl) {
              let t = new bootstrap.Toast(toastEl, { delay: 2600 }); 
              t.show();
          });
      });
   </script>
