                                        ...
                                        <td>
                                            ...
                                            @if($module->allow_show)
                                                <a href="{{ route('admin.modules.records.view', [$module->id, $record->id]) }}">
                                                 ...
                                                 @if ($module->name =='Labour Management')
                                                <a href="{{ route('admin.attendances.view', $record->id) }}" class="btn btn-sm btn-light" data-bs-toggle="tooltip" title="Attendance Sheet">
