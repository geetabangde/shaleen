                  ...
                  <div class="card-body p-4">
                     <div class="row g-3">
                           <div class="col-md-6">
                              ...
                              <input type="date" name="bags_date" class="form-control @error('bags_date') is-invalid @enderror" value="{{ old('bags_date') }}">
                              @error('bags_date') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-6">
                              <label class="form-label">Contract No.</label>
                              <input type="text" name="bags_contract_no" class="form-control @error('bags_contract_no') is-invalid @enderror" value="{{ old('bags_contract_no') }}">
                           ...
                           <div class="col-md-6">
                              ...
                              <select name="bags_buyer_name" class="form-control @error('bags_buyer_name') is-invalid @enderror" required>
                                 ...
                                 @foreach($buyers as $ledger)
                                       <option value="{{ $ledger->id }}" {{ old('bags_buyer_name') == $ledger->id ? 'selected' : '' }}>
                                          {{ $ledger->name }}
                                       </option>
                                 @endforeach
                              </select>
                           ...
                           <div class="col-md-6">
                              ...
                              <select name="bags_seller_name" class="form-control @error('bags_seller_name') is-invalid @enderror" required>
                                 ...
                                 @foreach($sellers as $ledger)
                                       <option value="{{ $ledger->id }}" {{ old('bags_seller_name') == $ledger->id ? 'selected' : '' }}>
                                          {{ $ledger->name }}
                                       </option>
                                 @endforeach
                              </select>
                           ...
                           <div class="col-md-6">
                              ...
                              <input type="text" name="bags_packing" class="form-control @error('bags_packing') is-invalid @enderror" value="{{ old('bags_packing') }}">
                              @error('bags_packing') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-6">
                              <label class="form-label">Number of Container</label>
                              <input type="number" name="bags_number_of_container" class="form-control @error('bags_number_of_container') is-invalid @enderror" value="{{ old('bags_number_of_container') }}">
                              @error('bags_number_of_container') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-6">
                              <label class="form-label">Marking</label>
                              <input type="text" name="bags_marking" class="form-control @error('bags_marking') is-invalid @enderror" value="{{ old('bags_marking') }}">
                              @error('bags_marking') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-6">
                              <label class="form-label">Price</label>
                              <input type="number" step="0.01" name="bags_price" class="form-control @error('bags_price') is-invalid @enderror" value="{{ old('bags_price') }}">
                              @error('bags_price') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-6">
                              <label class="form-label">Quantity</label>
                              <input type="number" name="bags_quantity" class="form-control @error('bags_quantity') is-invalid @enderror" value="{{ old('bags_quantity') }}">
                              @error('bags_quantity') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-6">
                              <label class="form-label">Number of </label>
                              <input type="number" name="bags_number_of" class="form-control @error('bags_number_of') is-invalid @enderror" value="{{ old('bags_number_of') }}">
                           ...
                           <div class="col-md-6">
                              ...
                              <select name="bags_broker" class="form-control @error('bags_broker') is-invalid @enderror" required>
                                 ...
                                 @foreach($brokers as $ledger)
                                       <option value="{{ $ledger->id }}" {{ old('bags_broker') == $ledger->id ? 'selected' : '' }}>
                                          {{ $ledger->name }}
                                       </option>
                                 @endforeach
                              </select>
                           ...
                           <div class="col-md-6">
                              ...
                              <input type="text" name="bags_delivery_at" class="form-control @error('bags_delivery_at') is-invalid @enderror" value="{{ old('bags_delivery_at') }}">
                              @error('bags_delivery_at') <div class="invalid-feedback">{{ $message }}</div> @enderror
                           </div>

                           <div class="col-md-12 mb-3">
                              <label class="form-label">Remark</label>
                              <textarea name="bags_remark" class="form-control @error('bags_remark') is-invalid @enderror">{{ old('bags_remark') }}</textarea>
