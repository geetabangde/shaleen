                        ...
                        <form action="{{ route('admin.sale.store') }}" method="post" enctype="multipart/form-data">
                           ...
                           <div class="card-body">
                              <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                          ...
                                          <select name="broker_name" class="form-control @error('broker_name') is-invalid @enderror" required>
                                             ...
                                             @foreach($brokers as $ledger)
                                                   <option value="{{ $ledger->id }}" {{ old('broker_name') == $ledger->id ? 'selected' : '' }}>
                                                      {{ $ledger->name }}
                                                   </option>
                                             @endforeach
                                          </select>
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <select name="party_name" class="form-control @error('party_name') is-invalid @enderror" required>
                                             ...
                                             @foreach($buyers as $ledger)
                                                   <option value="{{ $ledger->id }}" {{ old('party_name') == $ledger->id ? 'selected' : '' }}>
                                                      {{ $ledger->name }}
                                                   </option>
                                             @endforeach
                                          </select>
                                    ...
                                    <div class="col-md-6">
                                          <label class="form-label">Bags  Name</label>
                                          <select name="bags" class="form-control @error('bags') is-invalid @enderror" required>
                                             <option value="">Bags </option>
                                             @foreach($begs as $beg)
                                                   <option value="{{ $beg->id }}" {{ old('bags') == $beg->id ? 'selected' : '' }}>
                                                      {{ $beg->marking }}
                                                   </option>
                                             @endforeach
                                          </select>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <input type="text" name="loading_history_pending_balance" id="loading_history_pending_balance"
                                             ...
                                             value="{{ old('loading_history_pending_balance') }}">
